function searchWord(word, str) {
  ...
  var regexp = new RegExp('\\b' + word + '\\b', 'ig');
...
assertEqual(3, searchWord, 'sed', text);     
assertEqual(2, searchWord, 'aut', text);      
assertEqual(0, searchWord, 'john', text);      
assertEqual(undefined, searchWord, '', text);      
assertEqual(undefined, searchWord, 'sed', '');      
