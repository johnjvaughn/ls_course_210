...
function sentiment(text) {
  var posMatches = text.match(positiveRegex) || [];
  var posNum = posMatches.length;
  var negMatches = text.match(negativeRegex) || [];
  ...
  console.log('Positive sentiments: ' + posMatches.join(', ').toLowerCase());
  console.log('There are ' + String(negNum) + ' negative words in the text.');
  console.log('Negative sentiments: ' + negMatches.join(', ').toLowerCase());
