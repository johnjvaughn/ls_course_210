...
assertEqual(false, isBlockWord, 'BUTCH');
assertEqual(false, isBlockWord, 'APPLE');
assertEqual(false, isBlockWord, 'apple');
assertEqual(false, isBlockWord, 'apPLE');
assertEqual(false, isBlockWord, 'Box');
assertEqual(true, isBlockWord, 'BATCH');
assertEqual(true, isBlockWord, 'jest');
assertEqual(true, isBlockWord, 'floW');
